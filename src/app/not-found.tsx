...
export default function NotFound() {
    return (
        <div className="text-center flex flex-col items-center justify-center gap-y-4 h-[100vh]">
            ...
            <p className="text-lg mt-4">If you think this is a mistake, please contact <a href="mailto:jshaul@berkeley.edu" className=" underline"><CryptoText text="jshaul@berkeley.edu" /></a>. </p>
        </div>
    );
}