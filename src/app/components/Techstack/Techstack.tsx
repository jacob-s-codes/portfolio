...
import Imageforstack from './Imageforstack'
    ...
    <div>
      ...
      <div className=" h-[200px] rounded-2xl w-8xl">
        <Marquee className="gap-x-8 py-3 overflow-hidden grid" speed={150} pauseOnHover={true}>
          ...
          <Imageforstack src="/javalogo.webp" />
          <Imageforstack src="/javaslogo.png" />
          <Imageforstack src="/react.webp" />
          <Imageforstack src="/nodejs.png" />
          <Imageforstack src="/htmllogo.png" />
