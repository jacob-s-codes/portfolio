    ...
    <div className="w-full max-w-7xl  mx-auto lg:px-4 ">
      <div className="flex lg:flex-row flex-col-reverse lg:items-center items-start justify-between py-8">
        <div className="flex flex-col items-start gap-6 max-w-2xl">
          ...
          <h3 className="lg:text-xl text-base">Hi! My name is Jacob and I&apos;m a high school student at San Francisco University High School, previously interning <a href="https://tesseral.com/" target="_blank" className="text-paleslate hover:text-whiteaccent">@Tesseral</a></h3>
