    ...
    <div className="w-full max-w-7xl  mx-auto lg:px-4 ">
      <div className="flex lg:flex-row flex-col-reverse lg:items-center items-start justify-between py-8">
        <div className="flex flex-col items-start gap-6 max-w-2xl">
          ...
          <h3 className="lg:text-xl text-base">High school student at San Francisco University High School, previously interning at <a href="https://tesseral.com/" target="_blank" className="text-paleslate hover:text-white underline"><NoStyleCryptotext text={'Tesseral'}/></a>. As seen on <a href="https://www.cnn.com/2025/09/27/tech/sillicon-valley-seniors-ai-course" target="_blank" className="text-paleslate underline hover:text-white"><NoStyleCryptotext text={'CNN'}/></a>, <a href="https://www.nbcbayarea.com/video/news/local/sf-teen-is-helping-other-students-learn-computer-coding/3953420/" target='_blank' className="text-paleslate hover:text-white underline"><NoStyleCryptotext text={'NBC Bay Area'}/></a>, and more.</h3>
          <div className="flex items-center lg:gap-8 gap-6">
            ...
            <a href="mailto:jacobbshaul@gmail.com" className="hover:text-black border border-white hover:rounded-r-xl p-2 hover:bg-white duration-200">
