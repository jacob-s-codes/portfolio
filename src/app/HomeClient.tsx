    ...
    <div className="w-full  mx-auto lg:px-4 px-2 py-8">
      <div className="flex lg:flex-row flex-col-reverse lg:items-center items-start justify-between">
        <div className="flex flex-col items-start gap-6 max-w-2xl">
          ...
          <h3 className="lg:text-xl text-base">Hi! My name is Jacob and I&apos;m a high school student at San Francisco University High School, previously interning <a href="https://tesseral.com/" target="_blank" className="text-blue-500 hover:text-blue-300">@Tesseral</a></h3>
          <div className="flex items-center lg:gap-8 gap-6">
            ...
            <a href="https://www.linkedin.com/in/jacob-shaul-7729ba29b/" target="_blank" className="hover:text-black border border-white hover:rounded-r-xl pr-2 p-2 hover:bg-white duration-200">
