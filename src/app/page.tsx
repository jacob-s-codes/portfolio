      ...
      <div className="py-48">
        ...
        <div className=" my-12 rounded-4xl flex items-stretch justify-between overflow-hidden">
          ...
          <div className="w-full bg-lessdarkbg flex flex-col gap-y-6 justify-center">
            <h4 className="border mx-4 border-white w-fit px-6 py-1 rounded-3xl text-sm uppercase">Founder, frontend development</h4>
            <div className="px-4">
            ...
            <div className="flex flex-row items-center justify-between gap-x-8 pt-4 px-4 border-t-16 border-darkbg">
        ...
        <div className=" my-12 rounded-4xl flex flex-row-reverse items-stretch justify-between overflow-hidden">
          ...
          <div className="w-full bg-lessdarkbg flex flex-col gap-y-6 justify-center">
            <h4 className="border mx-4 border-white w-fit px-6 py-1 rounded-3xl text-sm uppercase">Organizer, frontend development, outreach</h4>
            <div className="px-4">
