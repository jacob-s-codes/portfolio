    ...
    <div className="w-full max-w-7xl mx-auto px-4 py-8">
      <div className="flex lg:flex-row flex-col-reverse lg:items-center items-start justify-between">
        <div className="flex flex-col items-start gap-6 max-w-2xl">
          ...
          <div className="flex items-center justify-between lg:text-2xl text-lg font-semibold w-full uppercase">
            <h2>Student</h2>
            <h2>|</h2>
          ...
          <h3 className="lg:text-xl text-base">Hi there! My name is Jacob and I&apos;m currently a high school student at San Francisco University High School. I&apos;m passionate about technology and software.</h3>
          <div className="flex items-center lg:gap-8 gap-6">
            ...
            <a href="mailto:jacobbshaul@gmail.com" className="hover:text-black border border-white rounded-xl p-2 hover:bg-white duration-200">
              <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="lg:w-10 w-8 h-auto bi bi-envelope" viewBox="0 0 16 16">
            ...
            <a href="https://www.linkedin.com/in/jacob-shaul-7729ba29b/" target="_blank" className="hover:text-black border border-white rounded-xl p-2 hover:bg-white duration-200">
              <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="bi bi-linkedin rounded-sm lg:w-10 w-8 h-auto" viewBox="0 0 16 16">
      ...
      <div className="py-48">
        ...
        <Projects/>
        <div className="">
          <a href="/projects"><button className="w-fit  hover:cursor-pointer border-white border px-12 py-4 hover:bg-lessdarkbg duration-200 ease-in hover:rounded-r-xl lg:text-2xl text-xl">Read more</button></a>
        </div>
      ...
      <div className="py-24">
        ...
        <div className="grid lg:grid-cols-7 grid-cols-3 gap-y-4 items-center justify-evenly">
